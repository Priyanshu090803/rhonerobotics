...
//   return (
//     <section className="py-24 px-14 md:px-6 bg-gray-50/50" id="services">
...
//         {/* Bento Grid Layout - Matches OrbAI style */}
...
//             icon={Sparkles}
//             className="lg:col-span-2 h-full bg-white"
...
//           {/* 6. Website Development (Square Card) */}
//           <ServiceCard
  ...
  return (
    <section className="py-16 md:py-24 px-6 md:px-10 bg-gray-50/50" id="services">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Bento Grid Layout - Responsive gaps and column spans */}
