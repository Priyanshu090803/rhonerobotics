  ...
  //       className={cn(
  //         "group relative overflow-hidden bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300",
  //         imageSrc ? "flex flex-col md:flex-row gap-8 items-center" : "flex flex-col items-start justify-between",
  //         className
  //       )}
  //     >
  //       {imageSrc && (
  //         <div className="w-full md:w-1/2 h-48 md:h-64 relative rounded-2xl overflow-hidden bg-gray-50">
  //           <Image
  //             src={imageSrc}
  //             alt={title}
  //             fill
  ...
  //       <div className={cn("flex flex-col items-start", imageSrc ? "w-full md:w-1/2" : "w-full")}>
  //         <div className="mb-6 p-3 bg-neutral-900 rounded-xl shadow-lg shadow-neutral-900/20 group-hover:-translate-y-1 transition-transform duration-300">
